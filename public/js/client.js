...
/***/ "./src/js/modules/them105/task1-1.js":
/*!*******************************************!*\
  !*** ./src/js/modules/them105/task1-1.js ***!
  \*******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"them105_1_1\": () => (/* binding */ them105_1_1)\n/* harmony export */ });\nconst them105_1_1 = () => {\r\n\tconst parent = document.querySelector('#them105_1-1_parent');\r\n\tlet form = parent.querySelector('form');\r\n\r\n\tform.addEventListener('submit', function (event) {\r\n\t\tevent.preventDefault();\r\n\t\tfetch('/them105_1-1/', {\r\n\t\t\tmethod: \"POST\",\r\n\t\t\tbody: new FormData(form)\r\n\t\t})\r\n\t\t\t.then(response => response.text())\r\n\t\t\t.then(text => console.log(text))\r\n\t})\r\n}\n\n//# sourceURL=webpack://base-setting-for-gulp/./src/js/modules/them105/task1-1.js?");

/***/ }),

/***/ "./src/js/modules/them105/task1.js":
/*!*****************************************!*\
  !*** ./src/js/modules/them105/task1.js ***!
  \*****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"them105_1\": () => (/* binding */ them105_1)\n/* harmony export */ });\nconst them105_1 = () => {\r\n\tconst parent = document.querySelector('#them105_1_parent');\r\n\tlet form = parent.querySelector('form');\r\n\r\n\tform.addEventListener('submit', function (event) {\r\n\t\tevent.preventDefault();\r\n\t\tfetch(\"them105_1\", {\r\n\t\t\tmethod: 'POST',\r\n\t\t\tbody: new FormData(this)\r\n\t\t})\r\n\t\t\t.then(response => response.text())\r\n\t\t\t.then(text => console.log(text));\r\n\t})\r\n}\n\n//# sourceURL=webpack://base-setting-for-gulp/./src/js/modules/them105/task1.js?");

/***/ }),

/***/ "./src/js/modules/them105/task2.js":
/*!*****************************************!*\
  !*** ./src/js/modules/them105/task2.js ***!
  \*****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"them105_2\": () => (/* binding */ them105_2)\n/* harmony export */ });\nconst them105_2 = () => {\r\n\tlet obj = {\r\n\t\ta: 1,\r\n\t\tb: 2,\r\n\t\tc: 3\r\n\t};\r\n\r\n\tlet date = new FormData();\r\n\r\n\tfor (let key in obj) {\r\n\t\tdate.set(`${key}`, `${obj[key]}`);\r\n\t};\r\n\r\n\tfetch('/them105_2/', {\r\n\t\tmethod: \"POST\",\r\n\t\tbody: date,\r\n\t})\r\n\t\t.then(response => response.text())\r\n\t\t.then(text => console.log(text))\r\n};\n\n//# sourceURL=webpack://base-setting-for-gulp/./src/js/modules/them105/task2.js?");
